...
export default function CreateEstimatePage({ onCancel, initialData }: { onCancel: () => void, initialData?: any }) {
    ...
    const handleSave = async () => {
        ...
        formData.append('documentType', 'ESTIMATE');
    ...
    return (
        <div className="bg-white rounded-lg shadow-md min-h-screen" style={{ pointerEvents: isCancelled ? 'none' : 'auto', opacity: isCancelled ? 0.85 : 1 }}>
            <div className="flex justify-between items-center p-4 border-b">
                <h1 className="text-xl font-bold">Estimate/Quotation</h1>
